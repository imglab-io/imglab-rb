...
describe Imglab::Srcset::Utils do
  describe ".normalize_params" do
    it "returns normalized params" do
      ...
      assert_equal Imglab::Srcset::Utils.normalize_params(blur: 100, dpr: [], width: [], format: "png"), {"blur" => 100, "format" => "png"}
      assert_equal Imglab::Srcset::Utils.normalize_params(blur: 100, dpr: 1, width: 100, format: "png"), {"blur" => 100, "dpr" => 1, "width" => 100, "format" => "png"}
      assert_equal Imglab::Srcset::Utils.normalize_params(blur: 100, dpr: [1, 2, 3], width: [100, 200, 300], format: "png"), {"blur" => 100, "dpr" => [1, 2, 3], "width" => [100, 200, 300], "format" => "png"}
      assert_equal Imglab::Srcset::Utils.normalize_params(blur: 100, dpr: 1..3, width: 100..300, format: "png"), {"blur" => 100, "dpr" => 1..3, "width" => 100..300, "format" => "png"}
    end
  end
